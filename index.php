...
<body>
    ...
    <header>
        <div id="header-output fixed-header fixed-header-dark" class="header-output fixed-header fixed-header-dark">
    ...
    <section  class="banner padding-tb-200px sm-ptb-80px background-overlay" style="background-image: url('assets/bg/bg.png'); height: 100vh">
        <div class="container z-index-2 position-relative">
            <div class="title">
                <h1 class="text-title-large text-main-color font-weight-300 margin-bottom-15px"><b>Peduli Diri</b></h1>
                ...
                <div class="col-lg-4 col-md-6 sm-mb-45px">
                    <div class="background-white full-width thum-hover box-shadow hvr-float wow fadeInUp" data-wow-delay="0.2s">
                        <div class="item-thumbnail thum background-white">
                            <a href="#"><img src="http://placehold.it/450x240" alt=""></a>
                        </div>
                        <div class="padding-30px">
